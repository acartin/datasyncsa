...
> Deprecated file path: this document was moved to `.agent/services/etl-docs/architecture.md`.
> Keep this copy only as legacy reference.
...
- **Service URL**:  corregir con nueva configuracion

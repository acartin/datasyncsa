#!/usr/bin/env python3
"""Wrapper del scraper VTEX configurable para Walmart Costa Rica."""
...
def parse_args():
    return build_arg_parser(
        description="Extrae el catalogo de Abarrotes de Walmart Costa Rica usando GraphQL paginado.",

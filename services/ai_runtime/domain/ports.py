...
class LLMPort(Protocol):
    ...
    async def extract_search_filters(self, prompt: str) -> dict[str, Any]: ...
    ...
    async def extract_lead_fields(self, prompt: str) -> dict[str, Any]: ...

    async def extract_appointment_fields(self, prompt: str) -> dict[str, Any]: ...

    async def score_turn(self, prompt: str) -> dict[str, Any]: ...

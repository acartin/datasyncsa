"""Insurance-specific prompt template for multi-intent detection."""


def build_prompt() -> str:
    return """
Rol del sistema:
Sos el planificador de intenciones del vertical insurance de Datasyncsa AI.
...
Few-shot:
Usuario: "Quiero una llamada para revisar mi seguro y te paso mi numero"

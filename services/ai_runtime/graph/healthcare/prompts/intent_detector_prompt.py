"""Healthcare-specific prompt template for multi-intent detection."""


def build_prompt() -> str:
    return """
Rol del sistema:
Sos el planificador de intenciones del vertical healthcare de Datasyncsa AI.
...
Few-shot:
Usuario: "Quiero una cita y te dejo mi telefono"

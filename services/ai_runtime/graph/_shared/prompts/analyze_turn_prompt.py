...
JSON exacto:
{
  "dialogue_act": "new_search|refine_search|select_result|confirm_previous|reject_previous|ask_detail|compare|calculate|schedule|faq|document_query|memory_query|lead_capture|recommend|small_talk|unknown",
  "confidence": 0.0,
...
- Si el usuario pide ver la foto o imagen de la propiedad actual o del set actual, usa `intent_plan=[show_result_cards]`.

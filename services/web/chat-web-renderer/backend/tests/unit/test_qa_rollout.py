...
class TestRolloutPlan:
    ...
    def test_should_block_listed_client(self):
        from app.core.rollout_plan import RolloutConfig, RolloutStage, ROLLOUT_CONFIG, should_enable_feature
        ROLLOUT_CONFIG["TEST_BLOCKED"] = RolloutConfig(
            feature_name="TEST_BLOCKED",
        ...
        result = should_enable_feature("TEST_BLOCKED", "blocked-client", default_enabled=True)
        assert result is False

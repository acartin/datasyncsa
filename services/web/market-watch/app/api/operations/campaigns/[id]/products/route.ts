...
export async function POST(
  ...
  const response = await fetch(`${API_BASE_URL}/operations/campaigns/${encodeURIComponent(id)}/products`, {
    method: "POST",
    headers: {
  ...
  return redirectWithFeedback(id, "success", "Campaign products assigned successfully.");
}

...
export async function POST(
  ...
  const response = await fetch(
    `${API_BASE_URL}/operations/campaigns/${encodeURIComponent(id)}/report-recipients/${encodeURIComponent(recipientId)}`,
    {
      method: "PATCH",
      headers: {
  ...
  return redirectWithFeedback(id, "success", "Report recipient updated successfully.");
}

...
export async function POST(
  ...
  const response = await fetch(`${API_BASE_URL}/operations/campaigns/${encodeURIComponent(id)}/chains`, {
    method: "POST",
    headers: {
  ...
  return redirectWithFeedback(id, "success", "Campaign chain assigned successfully.");
}

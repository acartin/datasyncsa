...
function normalizePayload(formData: FormData) {
  ...
  payload.is_default = payload.is_default === "on";
...
export async function POST(
  ...
  const response = await fetch(`${API_BASE_URL}/operations/campaigns/${encodeURIComponent(id)}/access`, {
    method: "POST",
    headers: {
  ...
  return redirectWithFeedback(id, "success", "Campaign access saved successfully.");
}
